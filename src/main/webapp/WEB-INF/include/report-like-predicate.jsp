<tr>
    <td style="padding: 20px">
        ...
        Movie.java is a Java Bean class to represent an entry in the movie table, and also has static
        ...
        method, which searches for movies starting with a particular letter (or number).<br><br>
        ...
        is the keywords a user will enter in the general, global search. This search is
        located at the top of every webpage of our fabflix website, and the keywords
        use the LIKE predicate with '%' surrounding both sides. The LIKE predicate
        ...
        the results will return anything containing the substring of what the user
        ...
        global search at the top of any page, or clicking "Adv. Search". Each attribute has its own search field
        in the advanced search and a query will be generated based on which fields the user
        filled out. Any combination of the fields entered will be ANDed together and all
        fields use the LIKE predicate for the same reason it is used for the global
        ...
        letter A-Z or a number 0-9. The LIKE predicate is used here by simply having a '%'
        on the right side of what the user clicked on, so if a user clicks on 'A', the
        like predicate would look like "LIKE A%". This will return any title match that starts
        with A.
    </td>
</tr>